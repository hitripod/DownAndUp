...
(function () {
                        ...
                        if (w.length)
                            for (var w = w.slice(0), k, g = 0; g < w.length; g++) {
                                if (m.errorProof) try {
                                    k = w[g].call(this,
                                        l, i, b, h)
                                } catch (p) {} else k = w[g].call(this, l, i, b, h);
    ...
    (function () {
        ...
        CKEDITOR.tools = {
            ...
            normalizeCssText: function (a, b) {
                var d = [],
                    c, h = CKEDITOR.tools.parseCssText(a, true, b);
            ...
            var a = this.$.cloneNode(b),
                f = function (a) {
                    ...
                    if (a.nodeType == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if (b)
                            for (var a = a.childNodes, e = 0; e < a.length; e++) f(a[e])
                    }
                };
            f(a);
            ...
            removeStyle: function (a) {
                ...
                if (!b.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
                    ...
                    for (var b = [], h = 0; h < c.length; h++)
                        if (e)
                            for (var j = 0; j < e.length; j++) b.push([a, c[h], e[j]].join("-"));
        ...
        function b(a, b) {
            ...
            if (a && !this._.guardRTL) {
                var E = m.type == CKEDITOR.NODE_ELEMENT ? m : m.getParent(),
                    B = m.type == CKEDITOR.NODE_ELEMENT ? q ? m.getChild(q - 1) : null : m.getPrevious();
            ...
            if (this.current) d = this.current[e](false, p, k);
                ...
                if (a) d.type ==
                    CKEDITOR.NODE_ELEMENT && (d = f > 0 ? d.getChild(f - 1) : k(d, true) === false ? null : d.getPreviousSourceNode(true, p, k));
                else {
                    d = m;
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            createBookmark2: function () {
                function a(b) {
                    ...
                    if (c.type == CKEDITOR.NODE_TEXT) {
                        g = c;
                        for (m = 0;
                            (g = g.getPrevious()) && g.type == CKEDITOR.NODE_TEXT;) m = m + g.getLength();
                        d = d + m
                    }
                    b.container = c;
                    b.offset = d
            ...
            enlarge: function (a, b) {
                                ...
                                if (h.type == CKEDITOR.NODE_TEXT) {
                                    ...
                                    if (j && CKEDITOR.dtd.$removeEmpty[h.getName()]) {
                                        ...
                                        if (/[^\s\ufeff]/.test(x)) h = null;
                                            ...
                                            for (var l = h.$.getElementsByTagName("*"),
                                                    s = 0, C; C = l[s++];)
                ...
                case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                    ...
                    var y, o, u = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {
                            br: 1
                        } : null),
                        I = function (a) {
                            var b = u(a);
    ...
    (function () {
                        ...
                        for (var e = g.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || g.name == "body", p, f = d.length; f > 0;) {
                            ...
                            if (e && (h.type == CKEDITOR.NODE_TEXT || h.type == CKEDITOR.NODE_ELEMENT && B.$inline[h.name])) {
                                ...
                                g.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && (h.type ==
                                    CKEDITOR.NODE_ELEMENT && !B[g.name][h.name]) && c.push({
                                    check: "el-up",
                                    el: h
                                })
                            }
        ...
        function v(a, b) {
            ...
            for (f in g)
                if (a.styles[f] != g[f]) return false;
            return true
        }
            ...
            var e = {}, h = function (a) {
                    b.call(this, a, function (a) {
                        ...
                        for (j in a) {
                            ...
                            if (!c[j]) {
                                if (q.icons)
                                    for (var k = q.icons.split(","), g = k.length; g--;) CKEDITOR.skin.addIcon(k[g], q.path + "icons/" + (CKEDITOR.env.hidpi && q.hidpi ? "hidpi/" : "") + k[g] + ".png");
                                c[j] = 1
                            }
                            if (w) {
                                w.split && (w = w.split(","));
        ...
        function m(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function (c) {
                ...
                for (var k in c) {
                    ...
                    if (i && (j = i.match(h)))
                        for (; i = j.pop();) CKEDITOR.tools.setTimeout(function (a, b) {
                    ...
                    if (o && !a.lang[k]) {
                        ...
                        } if (!q.langEntries || !q.langEntries[n]) f.push(CKEDITOR.getUrl(q.path + "lang/" + n + ".js"));
                        else {
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function (d, e, h) {
                    ...
                    if (d == "pre") E = true;
                        ...
                        for (;;) {
                            ...
                            if (!e.isUnknown && !t.isUnknown && !h[d])
                                ...
                                t = g
                            } else if (d in CKEDITOR.dtd.$listItem && !w(d, g)) k.onTagOpen(d == "li" ? "ul" : "dl", {}, 0, 1);
            ...
            k.onText = function (b) {
                ...
                var d = t.name,
                    e = d ? CKEDITOR.dtd[d] || (t._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : f;
                if (!n && !e["#"] && d in c) {
            ...
            function k(b, c) {
                return function (d) {
                    if (d.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if (k = CKEDITOR.env.opera && !b || (typeof c == "function" ? c(d) !== false : c))
                            if (!q && CKEDITOR.env.ie && d.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT) k = false;
                            else if (!q && CKEDITOR.env.ie && (document.documentMode > 7 || d.name in CKEDITOR.dtd.tr || d.name in CKEDITOR.dtd.$listItem)) k = false;
                        else {
                            k = a(d);
    ...
    (function () {
                ...
                insertElement: function (b) {
                    ...
                    for (var c = this.editor, d = c.config.enterMode,
                        ...
                        if (!n.checkReadOnly()) {
                            ...
                            if (j)
                                for (;
                                    (x = n.getCommonAncestor(0, 1)) && (z = CKEDITOR.dtd[x.getName()]) && (!z || !z[i]);)
                    ...
                    if (l) {
                        ...
                        if (j)
                            if ((b = l.getNext(a)) && b.type == CKEDITOR.NODE_ELEMENT && b.is(CKEDITOR.dtd.$block)) b.getDtd()["#"] ? n.moveToElementEditStart(b) : n.moveToElementEditEnd(l);
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (c in {
                                ...
                                if (e = d(e)) {
                                    ...
                                    if ((h = f.block) && b[c ? "checkStartOfBlock" : "checkEndOfBlock"]() && (j = h[c ? "getPrevious" : "getNext"](i)) && j.is("table")) {
                                        a.fire("saveSnapshot");
        ...
        var m = function () {
            ...
            return function (n, l, z) {
                ...
                if (!C.checkReadOnly()) {
                    var o = (new CKEDITOR.dom.elementPath(C.startContainer, C.root)).blockLimit || C.root,
                        l = {
                            type: l,
                            dontFilter: y,
                            editable: n,
                        ...
                        for (f(I, F); u < I.length; u++) {
                            ...
                            if (A = G.isLineBreak) {
                                ...
                                if (G.hasBlockSibling) A = 1;
                                    ...
                                    if (!M || !M.is({
                                        ...
                                        R = M.getPosition(K);
                                        if (R == CKEDITOR.POSITION_IDENTICAL || R == CKEDITOR.POSITION_CONTAINS) A = 0;
                                        else {
                                            K = A.splitElement(M);
                            ...
                            if (A) y = u > 0;
                                ...
                                if (P) {
                                    ...
                                    P = 0
                                } else F.insertNode(G.node); if (G.lastNotAllowed && u < I.length - 1) {
                ...
                if (a.length)
                    if (this.isLocked) {
                        ...
                        if (q) {
                            ...
                            var b = a[0],
                                a = b.collapsed,
                                i, l, j, m = b.getEnclosedNode();
                            if (m && m.type == CKEDITOR.NODE_ELEMENT && m.getName() in w && (!m.is("a") || !m.getText())) try {
                                j = m.$.createControlRange();
                                j.addElement(m.$);
                                j.select();
                                return
                            } catch (x) {}(b.startContainer.type == CKEDITOR.NODE_ELEMENT && b.startContainer.getName() in h || b.endContainer.type == CKEDITOR.NODE_ELEMENT && b.endContainer.getName() in h) && b.shrink(CKEDITOR.NODE_ELEMENT,
                                true);
                            j = b.createBookmark();
                            var h = j.startNode,
                                z;
                        ...
                        if (!s || i[s] && !t && (!n || h) && (m.getPosition(j) | CKEDITOR.POSITION_PRECEDING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED) == CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IDENTICAL + CKEDITOR.POSITION_IS_CONTAINED && (!e.childRule || e.childRule(m))) {
                            ...
                            if (v && ((v.getDtd() || CKEDITOR.dtd.span)[d] || f) && (!e.parentRule || e.parentRule(v))) {
                                ...
                                if (r == CKEDITOR.NODE_TEXT || n || r == CKEDITOR.NODE_ELEMENT && !m.getChildCount()) {
                                    for (var r = m, x;
                                        (g = !r.getNext(C)) && (x = r.getParent(), i[x.getName()]) && (x.getPosition(k) | CKEDITOR.POSITION_FOLLOWING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED) == CKEDITOR.POSITION_FOLLOWING + CKEDITOR.POSITION_IDENTICAL + CKEDITOR.POSITION_IS_CONTAINED && (!e.childRule ||
                                            e.childRule(x));) r = x;
                                    q.setEndAfter(r)
                                }
                            } else g = true
                        ...
                        for (var g = p(this, c), n = g.hasAttributes(), t = q.getCommonAncestor(), r = {}, s = {}, v = {}, z = {}, y, B, E; g && t;) {
                            if (t.getName() == d) {
                                for (y in e.attributes)
                                    if (!z[y] && (E = t.getAttribute(B))) g.getAttribute(y) == E ? s[y] = 1 : z[y] = 1;
                                for (B in e.styles)
                                    if (!v[B] && (E = t.getStyle(B))) g.getStyle(B) == E ? r[B] = 1 : v[B] = 1
                            }
                            t = t.getParent()
                        }
                ...
                a.addMode("wysiwyg", function (d) {
                    ...
                    var c = "document.open();" + (CKEDITOR.env.ie ? "(" + CKEDITOR.tools.fixDomain + ")();" : "") + "document.close();",
                        c = CKEDITOR.env.air ? "javascript:void(0)" :
                            CKEDITOR.env.ie ? "javascript:void(function(){" + encodeURIComponent(c) + "}())" : "",
                    ...
                    var f = CKEDITOR.tools.getNextId(),
                        i = CKEDITOR.dom.element.createFromHtml('<span id="' +
