...
~~~sh
# getting the code
git clone git@github.com:nko4/quick-hitter.git && cd ./quick-hitter/

# developing
npm install
npm start

# deploying (to http://quick-hitter.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@quick-hitter.2013.nodeknockout.com
ssh root@quick-hitter.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@quick-hitter.2013.nodeknockout.com
ssh -i ./id_deploy root@quick-hitter.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/quick-hitter" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
